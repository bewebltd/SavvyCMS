...
namespace Models {
	public partial class DynamicImage {
		/// <summary>
		/// Sets all fields to default values and sets up meta data. This is called automatically when you instantiate a new DynamicImage object.
		/// </summary>
		public override void InitDefaults() {
			// Alter this code to set appropriate defaults and meta data
			Fields.ImageUrl.MetaData = GetPicMetaData();
