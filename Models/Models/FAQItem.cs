...
namespace Models {
	public partial class FAQItem {
		/// <summary>
		/// Sets all fields to default values and sets up meta data. This is called automatically when you instantiate a new FAQItem object.
		/// </summary>
