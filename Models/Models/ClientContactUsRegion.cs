...
namespace Models {
	public partial class ClientContactUsRegion {
		/// <summary>
		/// Sets all fields to default values and sets up meta data. This is called automatically when you instantiate a new ClientContactUsRegion object.
		/// </summary>
