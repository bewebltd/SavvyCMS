...
namespace Models {
	public partial class NewsRSS {
		/// <summary>
		/// Sets all fields to default values and sets up meta data. This is called automatically when you instantiate a new NewsRSS object.
		/// </summary>
