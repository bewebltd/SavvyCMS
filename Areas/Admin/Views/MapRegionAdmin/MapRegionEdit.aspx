<%@ Page Title="Edit Map Region" Inherits="System.Web.Mvc.ViewPage<Models.MapRegion>" Language="C#" MasterPageFile="~/Areas/Admin/admin-no-form.master" %>
			...
			<tr>
				<td colspan="2" class="footer">
					...
					<div class="extra-footer-buttons">
						<%=Html.SavvyHelpText(new Beweb.HelpText("Map Region Edit")) %>
